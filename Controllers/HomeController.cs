            ...
            var model = new LandingPageViewModel
            {
                ...
                Features = new List<FeatureModel>
                {
                    new FeatureModel
                    {
                        ...
                        Description = "Optimized UI performance",
                ...
                TeamMembers = new List<TeamMemberModel>
                {
                    new TeamMemberModel
                    {
                        Name = "John Smith",
                        Role = "CEO",
                        Image = "/material-theme/assets/team-member-1.png"
                    },
                    new TeamMemberModel
                    {
                        Name = "Sara Lee",
                        Role = "Designer",
                        Image = "/material-theme/assets/team-member-2.png"
                    },
                    new TeamMemberModel
                    {
                        Name = "David Kim",
                        Role = "Developer",
                        Image = "/material-theme/assets/team-member-3.png"
                    }
                },
                ...
                FAQs = new List<FaqModel>
                {
                    new FaqModel
                    {
                        ...
                        Answer = "Yes for demo purposes."
                    },
                    new FaqModel
                    {
                        Question = "Can I customize it?",
                        Answer = "Yes it is fully customizable."
                    }
                },
